...
VFLUI.RegisterSound("Sound\\Event Sounds\\Wisp\\WispYes1.wav", "Wisp Sound");
VFLUI.RegisterSound("Sound\\Spells\\bind2_Impact_Base.wav", "Roar");
VFLUI.RegisterSound("Sound\\Spells\\ShaysBell.wav", "Chimes");
