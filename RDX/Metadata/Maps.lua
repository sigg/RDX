...
--if not Nx then Nx = {}; end

----------------------------------------------
-- Continents table OLD Map.MapInfo
----------------------------------------------
RDXMAP.RegisterContinent({
	cid = 1,
	Name = "Kalimdor",
	FileName = "Kalimdor",
	X = -1800,	-- Was 0
...
----------------------------------------------
-- Zones table OLD Map.MapWorldInfo
----------------------------------------------
...
--		City = true,
	...
	[20000] = {	-- Merged into Hillsbrad Foothills for Cataclysm
