...
RDX.RegisterFeature({
	...
	CreateDescriptor = function()
		return { feature = "Subframe"; name = "subframe1"; owner = "Frame_decor"; w = 90; h = 14; anchor = { lp = "TOPLEFT", af = "Frame_decor", rp = "TOPLEFT", dx = 0, dy = 0}; flOffset = 1; bkd = VFL.copy(VFLUI.defaultBackdrop); };
	end;
});
