...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		local owner = RDXUI.MakeSlotSelectorDropdown(ui, VFLI.i18n("Animation Group"), state, "AGText_", nil);
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		local owner = RDXUI.MakeSlotSelectorDropdown(ui, VFLI.i18n("Animation Group"), state, "AGText_");
		if desc and desc.owner then owner:SetSelection(desc.owner); end
