...
RDXEvents:Bind("INIT_POST_DATABASE_LOADED", nil, function()
	...
	local mbo = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame1_" .. RDX.pspace);
	...
	local mbsl = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame1");
	if mbsl.ty ~= "SymLink" or mbsl.data.class ~= "name&realm" then
		mbsl.ty = "SymLink"; mbsl.version = 3; mbsl.data = {class = "name&realm", dk = "RDXDiskSystem", pkg = "tabs", prefixfile = "ChatFrame1_", ty = "TabChatFrame"};
	end
	
	local mbo = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame2_" .. RDX.pspace);
	if not mbo.data then
		mbo.ty = "TabChatFrame"; 
		mbo.version = 1;
		mbo.data = {
	...
	local mbsl = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame2");
	if mbsl.ty ~= "SymLink" or mbsl.data.class ~= "name&realm" then
		mbsl.ty = "SymLink"; mbsl.version = 3; mbsl.data = {class = "name&realm", dk = "RDXDiskSystem", pkg = "tabs", prefixfile = "ChatFrame2_", ty = "TabChatFrame"};
	end
	
	local mbo = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame3_" .. RDX.pspace);
	if not mbo.data then
		mbo.ty = "TabChatFrame"; 
		mbo.version = 1;
		mbo.data = {
	...
	local mbsl = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame3");
	if mbsl.ty ~= "SymLink" or mbsl.data.class ~= "name&realm" then
		mbsl.ty = "SymLink"; mbsl.version = 3; mbsl.data = {class = "name&realm", dk = "RDXDiskSystem", pkg = "tabs", prefixfile = "ChatFrame3_", ty = "TabChatFrame"};
	end
	
	local mbo = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame4_" .. RDX.pspace);
	if not mbo.data then
		mbo.ty = "TabChatFrame"; 
		mbo.version = 1;
		mbo.data = {
	...
	local mbsl = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame4");
	if mbsl.ty ~= "SymLink" or mbsl.data.class ~= "name&realm" then
		mbsl.ty = "SymLink"; mbsl.version = 3; mbsl.data = {class = "name&realm", dk = "RDXDiskSystem", pkg = "tabs", prefixfile = "ChatFrame4_", ty = "TabChatFrame"};
	end
	
	local mbo = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame5_" .. RDX.pspace);
	if not mbo.data then
		mbo.ty = "TabChatFrame"; 
		mbo.version = 1;
		mbo.data = {
	...
	local mbsl = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame5");
	if mbsl.ty ~= "SymLink" or mbsl.data.class ~= "name&realm" then
		mbsl.ty = "SymLink"; mbsl.version = 3; mbsl.data = {class = "name&realm", dk = "RDXDiskSystem", pkg = "tabs", prefixfile = "ChatFrame5_", ty = "TabChatFrame"};
	end
	
	local mbo = RDXDB.TouchObject("RDXDiskSystem:tabs:ChatFrame6_" .. RDX.pspace);
	if not mbo.data then
		mbo.ty = "TabChatFrame"; 
		mbo.version = 1;
		mbo.data = {
